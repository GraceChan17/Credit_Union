...
forvalues year = 2001/2020 {
    ...
    * Keep necessary productdescription
    keep if productdescription == "120MoCD"
    ...
    * Save main yearly file
    save 120MoCD_`year'.dta, replace
   
}

* Merge all years
use 120MoCD_2001_new.dta, clear
forvalues year = 2002/2020 {
    append using 120MoCD_`year'_new.dta
}
...
* Import data: Deposit_InstitutionDetails.txt
clear
...
* Import data: Deposit_InstitutionDetails.txt
clear
use "/Volumes/WD Drive +/CreditUnion/Data/combined_dataset/combined_necessary_uniqueid_dropyear2000.dta", clear
